  ...
  <main class="w-5/6 mx-auto min-h-screen">
    ...
    <div class="flex items-center justify-between px-4 py-3 sm:px-6">
      <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm w-1/6 mx-auto" aria-label="Pagination">
        <a @click.prevent="filterDestination(1)"
          class="relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0 hover:cursor-pointer">
        ...
        <a
          @click.prevent="filterDestination(pageCount)"
