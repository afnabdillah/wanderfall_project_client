  ...
  <main class="w-4/5 mx-auto mt-8 min-h-screen">
    ...
    <div v-else-if="!loading">
      ...
      <div
        ...
        :class="[showAddSchedule ? 'h-[30rem] scale-y-100' : 'h-0 scale-y-0']"
      >
        <form @submit.prevent="addToSchedule">
          ...
          <div class="grid grid-cols-6 mt-4">
            <div v-if="loading" class="flex justify-center items-center w-16">
              <div
                class="inline-block border-green-400 h-8 w-8 animate-spin rounded-full border-4 border-solid border-current border-r-transparent align-[-0.125em] motion-reduce:animate-[spin_1.5s_linear_infinite] my-3.5"
                role="status"
              >
      ...
      <div class="pb-20" v-if="showAddReview">
        <div v-if="loading" class="flex justify-center items-center h-36 w-2/3">
          <div
            class="inline-block border-green-400 h-8 w-8 animate-spin rounded-full border-4 border-solid border-current border-r-transparent align-[-0.125em] motion-reduce:animate-[spin_1.5s_linear_infinite] my-3.5"
            role="status"
          >
        ...
        <form v-else-if="!loading" @submit.prevent="submitReview">
      ...
      <div class="pb-20" v-else-if="!showAddReview">
        ...
        >
          <p class="text-left text-xl">
            There aren't any review yet! Be the first person to review this
            place!
          </p>
        </div>
        <ReviewCard
